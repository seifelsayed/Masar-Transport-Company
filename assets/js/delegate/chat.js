    ...
    const contentHtml = `
      <div class="h-[calc(100vh-120px)] flex flex-col space-y-4">
        <div class="flex-shrink-0">
          ...
          <p class="text-white/40 text-sm mt-1">تواصل مباشر مع الإدارة</p>
        </div>

        <div class="flex-1 flex bg-white/5 rounded-3xl border border-white/5 overflow-hidden min-h-0">
          <aside class="w-64 border-l border-white/5 flex flex-col bg-white/[0.02]">
            ...
            <button class="w-full flex items-center gap-3 p-4 bg-blue-600 shadow-lg shadow-blue-600/20 transition-all text-right">
              ...
              <div class="flex-1 min-w-0">
                <p class="text-white text-xs font-bold truncate">الإدارة</p>
                <p class="text-[10px] text-white/60 truncate">${chatMessages.length > 0 ? chatMessages[chatMessages.length - 1].text : 'لا توجد رسائل'}</p>
              </div>
            </button>
          </aside>
          ...
          <main class="flex-1 flex flex-col min-w-0">
            <header class="p-4 border-b border-white/5 flex items-center gap-3 bg-white/[0.01]">
              ...
              <div>
                <h4 class="text-white font-bold text-sm">الإدارة</h4>
                <p class="text-[10px] text-white/30">مشرف النظام</p>
              </div>
            </header>
